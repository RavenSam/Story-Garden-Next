...
function getSafeRanges(dangerous) {
   ...
   if (dangerous.startContainer !== a) for (let i = dangerous.startContainer; i !== a; i = i.parentNode) s.push(i)
   if (0 < s.length)
   ...
   const e = new Array(0),
      re = new Array(0)
   if (dangerous.endContainer !== a) for (let i = dangerous.endContainer; i !== a; i = i.parentNode) e.push(i)
   if (0 < e.length)
